...
const sendMailer = async function (options) {
  const transporter = nodeMailer.createTransport({
    host: "live.smtp.mailtrap.io",
    port: 587,
    auth: {
      user: "api",
      pass: "4faa6b0e7408802399404f34fcbd9360",
    },
  });
  const message = {
    from: `Dhaanish <mailtrap@demomailtrap.com>`,
    to: options.to,
                    ...
                    <tbody>
                      ...
                      <tr>
                        <td align="center" valign="top" class="header-logo" style="-ms-text-size-adjust:100%;-webkit-text-size-adjust:100%;mso-table-lspace:0pt;mso-table-rspace:0pt;padding:10px 50px 30px;">
                          <!-- // Logo block // -->
                          <a href="//mailtrap.io" target="_blank" style="-ms-text-size-adjust:100%;-webkit-text-size-adjust:100%;color:#4DC3C9;text-decoration:none;"><img src="/images/amazonLogo.png" alt="M-Mart" width="146" height="30" style="-ms-interpolation-mode: bicubic; border: 0; display: block; max-width: 100%; outline: none; text-decoration: none; vertical-align: middle; width: auto"></a>
                        </td>
                      </tr>
                      <tr>
                            ...
                            <tbody>
                              <tr>
                                <td align="center" valign="middle" class="mobile-centered-container" style="-ms-text-size-adjust:100%;-webkit-text-size-adjust:100%;mso-table-lspace:0pt;mso-table-rspace:0pt;">
                                  <h1 class="header-heading mobile-centered-item" style="color:#fff;font-size:24px;letter-spacing:-.43px;line-height:30px;margin:0;padding:0 0 20px;">M-Mart introduces support for recovering password securely</h1>
                                  <div>
                                    <p class="header-text mobile-centered-item" style="-ms-text-size-adjust:100%;-webkit-text-size-adjust:100%;color:#fff;font-size:11px;line-height:14px;margin:0;padding-bottom:0;">
                                      <a href="//mailtrap.io" target="_blank" style="-ms-text-size-adjust:100%;-webkit-text-size-adjust:100%;color:#ffffff !important;text-decoration:none;"><strong>M-Mart</strong></a>
                                      <span style="padding: 0 11px 0 10px">|</span>Safe password recovering for users
                                      </p>
                                    </div>
                                  </td>
                                </tr>
                              ...
                              <tbody>
                                ...
                                <tr>
                                  <td align="left" valign="top" class="content-item" style="-ms-text-size-adjust:100%;-webkit-text-size-adjust:100%;mso-table-lspace:0pt;mso-table-rspace:0pt;padding-bottom:25px;">
                                    <h1 style="color:#4A4A4A;font-size:24px;letter-spacing:-.7px;line-height:29px;margin:0;padding:0;text-align:center">
                                      <span class="highlighted-text" style="color: #000">M-Mart Support</span>
                                    </h1>
                                  </td>
                                </tr>
                                <tr>
                                  <td align="left" valign="top" class="content-item" style="-ms-text-size-adjust:100%;-webkit-text-size-adjust:100%;mso-table-lspace:0pt;mso-table-rspace:0pt;padding-bottom:25px;">
                                    ...
                                    <table border="0" cellpadding="0" cellspacing="0" width="100%" style="-ms-text-size-adjust:100%;-webkit-text-size-adjust:100%;border-collapse:collapse;mso-table-lspace:0pt;mso-table-rspace:0pt;">
                                      <tbody>
                                        <tr>
                                          <td align="left" valign="top" style="-ms-text-size-adjust:100%;-webkit-text-size-adjust:100%;mso-table-lspace:0pt;mso-table-rspace:0pt;display:flex;justify-content:center;align-items:center">
                                            <img src="https://upload.wikimedia.org/wikipedia/commons/thumb/4/4a/Amazon_icon.svg/600px-Amazon_icon.svg.png?20210720180728" alt="verification changes" class="is-fittogrid" style="-ms-interpolation-mode: bicubic; border: 0; display: block;  outline: none; text-decoration: none; width: 25%">
                                          </td>
                                        </tr>
                                      </tbody>
                                    </table>
                                ...
                                <tr>
                                  <td align="left" valign="top" class="content-item" style="-ms-text-size-adjust:100%;-webkit-text-size-adjust:100%;mso-table-lspace:0pt;mso-table-rspace:0pt;padding-bottom:25px;">
                                    <p style="-ms-text-size-adjust:100%;-webkit-text-size-adjust:100%;margin:0;">${options.message}</p>
                                  </td>
                                </tr>
                              </tbody>
                            </table>
  ...
  const testMail = await transporter.sendMail(message);
};
